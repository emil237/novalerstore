#!/bin/sh
#
###command=wget -q "--no-check-certificate" https://raw.githubusercontent.com/emil237/novalerstore/main/ipsat.sh -O - | /bin/sh
###########################
PYTHON_VERSION=$(python -c"import platform; print(platform.python_version())")
##########################
echo " remove old plugins "
if [ -d /usr/lib/enigma2/python/Plugins/Extensions/IPSAT ]; then
echo "> removing package please wait..."
sleep 1;
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/IPSAT > /dev/null 2>&1
fi
...
cd /tmp
set -e
wget --show-progress "$url/ipsat-py3.11-9.5-r0.ipk"
sleep 1;
opkg install --force-reinstall ipsat-py3.11-9.5-r0.ipk
set +e
cd ..
wait
rm -f /tmp/ipsat-py3.11-9.5-r0.ipk
...
cd /tmp
set -e
wget --show-progress "$url/ipsat-py3.12-9.5-r0.ipk"
sleep 1;
opkg install --force-reinstall ipsat-py3.12-9.5-r0.ipk
set +e
cd ..
wait
rm -f /tmp/ipsat-py3.12-9.5-r0.ipk
...
cd /tmp
set -e
wget --show-progress "$url/ipsat-py2-9.5-r0.ipk"
sleep 1;
opkg install --force-reinstall ipsat-py2-9.5-r0.ipk
set +e
cd ..
wait
rm -f /tmp/ipsat-py2-9.5-r0.ipk
