...
if [ -d /usr/lib/enigma2/python/Plugins/Extensions/Beengo ]; then
echo "> removing package please wait..."
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/Beengo > /dev/null 2>&1
fi
status='/var/lib/opkg/status'
package='enigma2-plugin-extensions-beengo'
...
cd /tmp
set -e
wget --show-progress "$url/beengo-py3.11-10.0-r0.ipk"
sleep 1;
opkg install --force-reinstall beengo-py3.11-10.0-r0.ipk
set +e
cd ..
wait
rm -f /tmp/beengo-py3.11-10.0-r0.ipk
...
cd /tmp
set -e
wget --show-progress "$url/beengo-py3.12-10.0-r0.ipk"
sleep 1;
opkg install --force-reinstall beengo-py3.12-10.0-r0.ipk
set +e
cd ..
wait
rm -f /tmp/beengo-py3.12-10.0-r0.ipk

elif [ "$PYTHON_VERSION" == 3.9.9 -o "$PYTHON_VERSION" == 3.9.7 -o "$PYTHON_VERSION" == 3.9.6 -o "$PYTHON_VERSION" == 3.8.5 ]; then
echo ":You have $PYTHON_VERSION image ..."
cd /tmp
set -e
wget --show-progress "$url/beengo-py3.9-10.0-r0.ipk"
sleep 1;
opkg install --force-reinstall beengo-py3.9-10.0-r0.ipk
set +e
cd ..
wait
rm -f /tmp/beengo-py3.9-10.0-r0.ipk

elif [ "$PYTHON_VERSION" == 2.7.18 ]; then
echo ":You have $PYTHON_VERSION image ..."
cd /tmp
set -e
wget --show-progress "$url/beengo-py2-10.0-r0.ipk"
sleep 1;
opkg install --force-reinstall beengo-py2-10.0-r0.ipk
set +e
cd ..
wait
rm -f /tmp/beengo-py2-10.0-r0.ipk
